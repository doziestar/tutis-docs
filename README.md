...
The Tutis-ID server only accepts hashes to be signed. For document signing the relying
...
The Tutis-ID service reserves the right to add new fields into responses of the current RP API
